...
public class PlanRequest {
    ...
    @Min(value = -1, message = "Max leave policies must be -1 (unlimited) or positive")
    private Integer maxLeavePolicies;

    @Min(value = -1, message = "Max holidays must be -1 (unlimited) or positive")
    ...
    @PositiveOrZero(message = "Price per employee must be zero or positive")
